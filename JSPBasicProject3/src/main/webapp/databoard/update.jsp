...
<body>
  <div class="container">
    ...
    <div class="row">
      ...
      <table class="table">
        <tr>
          <th class="text-center dager" width=15%>이름</th>
          <td width=85%>
