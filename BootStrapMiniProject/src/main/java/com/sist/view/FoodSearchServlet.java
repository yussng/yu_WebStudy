...
public class FoodSearchServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 사용자 요청값을 받는다
		//request.setCharacterEncoding("UTF-8"); //MainServlet에
		...
		out.println("<input type=submit value=검색 class=\"btn btn-sm btn-danger\">"); //공백이 있으면 따옴표 붙여야함
		out.println("</form>");
		out.println("</td>");
		out.println("</tr>");
		out.println("</table>");
		...
		for(FoodVO vo:list)
		{
			...
			out.println("<a href=\"#\">");
			out.println("<img src=\""+vo.getPoster()+"\" alt=\"Light\" style=\"width:100%\">");
