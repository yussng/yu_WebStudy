     ...
     <table class="table">
       ...
       <table class="table">
         ...
         <tr> 
           ...
           <td width=20% class="text-center">${rvo.no }</td>
           <th width=20% class="text-center">예약일</th>
           <td width=20% class="text-center">${rvo.rday }</td>
         </tr>
         <tr> 
           <th width=20% class="text-center">예약시간</th>
           <td width=20% class="text-center">${rvo.rtime }</td>
           <th width=20% class="text-center">인원</th>
           <td width=20% class="text-center">${rvo.inwon }</td>
         </tr>
         <tr> 
