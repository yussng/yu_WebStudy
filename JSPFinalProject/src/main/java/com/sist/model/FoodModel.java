...
public class FoodModel {
	 ...
	 *        => RequestDispathcer rd=request.getRequestDispatcher(jsp)
	...
	public String food_list(HttpServletRequest request,HttpServletResponse response)
	{
		...
		// DispatcherServlet => 매개변수로 전송 => 전송된 request에 값을 채운다   setAttribute
	...
	public String food_detail_befor(HttpServletRequest request,HttpServletResponse response)
	{
		// Cookie 생성
