...
public class CartModel {
	...
	public String cart_insert(HttpServletRequest request,HttpServletResponse reponse)
	{
	...
	public void cart_buy(HttpServletRequest request,HttpServletResponse reponse)
	{
		String no=request.getParameter("cart_no");
		CartDAO dao=CartDAO.newInstance();
		dao.adminpageCartListData(Integer.parseInt(no));
