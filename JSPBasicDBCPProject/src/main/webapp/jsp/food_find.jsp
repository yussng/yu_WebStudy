...
<%
	...
	*/
	int startPage=((curpage-1)/BLOCK*BLOCK)+1; // 1 2 3 ...
	// 8. 끝나는 위치
	    ...
	    <div class="text-center">
	      <ul class="pagination">
	        ...
	        <%
	        	...
	        	{
	        %>
			 <li <%=i==curpage?"class=active":"" %>><a href="food_find.jsp?page=<%=i%>&addr=<%=fd%>"><%=i %></a></li> <!-- class=cative 파란색 -->
			<%
	        	}
			%>
			<%
